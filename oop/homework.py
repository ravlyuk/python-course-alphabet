...
class Cat:
    ...
    * Implement get_average_speed and return average_speed
    ...
    def run(self, hours):
        ...
        return f"Yours cat ran {ran_km} kilometers"
...
class Wall():
    ...
    * Implement method number_of_rolls_of_wallpaper which receives such parameters: roll_width_m, roll_length_m
    ...
    def wall_square(self): return self.width * self.height
...
class Window:
    ...
    def window_square(self): return self.width * self.height
...
class House:
    ...
    * Implement method get_room_square that returns the square of our room
    ...
    def get_number_of_rolls_of_wallpapers(self, roll_width_m, roll_height_m):
        if roll_height_m == 0 or roll_width_m == 0: raise ValueError("Sorry length must be not 0")
